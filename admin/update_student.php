...
?>
    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="lname" id="lastname" placeholder="Enter Last Name" value = "<?php echo $row['lname']; ?>">
        </div>
        <div class="form-group">
            <label for="roll">Roll No.</label>
            <input type="number" class="form-control" name="rollno" required id="roll" placeholder="Enter Roll No." value = "<?php echo $row['rollno']; ?>">
        </div>
        <div class="form-group">
